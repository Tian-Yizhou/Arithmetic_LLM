# Replicate Arithmetic_LLM

**NOTICE**

To replicate this project, you can run the following commands one by one, or run the script `run_exp.sh`. All commands/files should be executed in the root directory of the project.

```{bash}
# replicate the whole project
bash run_exp.sh
```
